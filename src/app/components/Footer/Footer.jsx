...
export default function Footer() {
  return (
    <footer className="h-screen flex items-center justify-center w-full bg-background relative" id="footer">
      <div className="w-screen h-screen absolute top-0 left-0">
        ...
        >
          <foreignObject x="-6.6" y="0.024025" width="1933.2" height="1005.35">
            <div xmlns="http://www.w3.org/1999/xhtml"></div>
          </foreignObject>
          <g filter="url(#filter0_d_73_700893)" data-figma-bg-blur-radius="20">
            <mask
              ...
              fill="black"
            >
              <rect fill="white" x="74" y="78.624" width="1772" height="845" />
      ...
      <div className=" py-[8%] px-[12vw] z-10 flex items-start justify-between left-0 w-full flex-col h-full ">
        <div className="h-[90%] gap-[10vw] w-full flex  items-center justify-between">
          <div className="w-[50%]  flex flex-col h-[90%] items-start justify-between">
          ...
          <div className="w-[45%]  text-[#A8A8A8] py-[5vw] flex flex-col h-[90%] items-end justify-between gap-16">
              ...
              <div className="pt-5 flex items-start gap-5">
                {["fb", "ld", "x", "ig"].map((item, index) => (
                  <div
                    ...
                    className="bg-background p-5  flex items-center justify-center"
                  >
                    <Image
                      src={`/assets/${item}.svg`}
                      width={item === "fb" ? 10 : 15}
                      height={item === "fb" ? 10 : 15}
                      alt="facebook"
                      className="w-full h-full"
                    />
                  </div>
        ...
        <div className="w-full h-[10%] flex items-end justify-between text-[#A8A8A8] text-[1vw]">
