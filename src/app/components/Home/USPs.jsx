      ...
      <div className="flex items-center justify-center w-full flex-col gap-16">
        <div className="flex items-center gap-20 h-full w-full justify-center">
          <div className="w-[40%] items-end justify-end flex h-full">
            ...
            >
              ...
              />
              <path
                d="M153.329 120.711L150.501 117.883L116.501 151.883L98.5009 133.883L95.6729 136.711L116.501 157.539L153.329 120.711Z"
                stroke="white"
                strokeWidth="4"
                strokeLinejoin="round"
              />
        ...
        <div className="flex items-center gap-20 h-full w-full justify-center">
          <div className="w-[40%] items-end justify-end flex h-full">
            ...
            >
              <path
                d="M185.51 48.7578C186.488 48.7578 187.329 48.9507 188.063 49.3076C188.794 49.6625 189.465 50.2073 190.072 50.9873L190.111 51.0361L204.229 67.8809L204.251 67.9082L204.275 67.9336C204.852 68.568 205.207 69.2429 205.383 69.9688C205.567 70.7321 205.675 71.5831 205.694 72.5283L205.697 72.9395V191.039C205.697 195.079 204.338 198.497 201.584 201.381L201.312 201.658C198.379 204.591 194.874 206.04 190.696 206.04H58.251C54.0648 206.04 50.5552 204.59 47.6221 201.657C44.6884 198.724 43.2394 195.217 43.2393 191.039V72.9492C43.2393 71.8429 43.3516 70.8554 43.5635 69.9785C43.7398 69.2487 44.0955 68.5729 44.667 67.9385L44.708 67.8916L58.8252 51.0469L58.8428 51.0254L58.8594 51.0039C59.4766 50.2183 60.1515 49.6716 60.877 49.3164C61.5131 49.005 62.2376 48.8148 63.0723 48.7686L63.4365 48.7578H185.51ZM50.1113 191.039C50.1114 193.312 50.8604 195.302 52.4189 196.86C53.9789 198.42 55.9726 199.168 58.251 199.168H190.696C192.97 199.168 194.959 198.419 196.518 196.86C198.076 195.302 198.825 193.312 198.825 191.039V76.3857H50.1113V191.039ZM103.53 118.587L82.9863 139.132L81.749 140.369L82.9863 141.607L103.53 162.151L98.5371 167.145L71.7617 140.369L98.5361 113.594L103.53 118.587ZM177.692 140.369L150.918 167.145L145.925 162.151L167.707 140.369L166.469 139.132L145.924 118.587L150.918 113.594L177.692 140.369ZM63.4941 56.2568L54.6768 66.6299L52.2266 69.5127H196.71L194.26 66.6299L185.442 56.2568L184.919 55.6406H64.0176L63.4941 56.2568Z"
                fill="none"
                stroke="white"
                strokeWidth="2"
              />
