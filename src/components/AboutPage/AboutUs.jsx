        ...
        <div className="w-full flex items-center justify-between max-sm:flex-col">
          <div className="flex flex-col gap-y-[5vw] text-black-1 w-[58%] max-sm:w-full max-md:w-[55%] max-sm:gap-y-[120vw]">
            <Copy>
              ...
              Monielink is a neobank platform designed to help Banks and Fintechs deliver full-scale digital banking experiences directly within their Mobile apps. With our all-in-one Super SDK, partners can integrate and launch secure, compliant, and feature-rich products & services, faster and more efficiently than ever before.
              </h2>
            </Copy>
