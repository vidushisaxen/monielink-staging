...
const AboutUs = () => {
  ...
  return (
    <>
      <section
        data-theme="white"
        className="bg-white-1 p-[8vw] white max-sm:px-[5.5vw] max-sm:py-[25%]"
      >
        <div className="w-full flex items-center justify-between max-sm:flex-col">
          <div className="flex flex-col gap-y-[5vw] text-black-1 w-[58%] max-sm:w-full max-sm:gap-y-[20vw]">
            <Copy>
            ...
            <div className="w-full flex justify-center">
              <div className="flex items-end flex-col w-[85%] max-sm:block hidden">
                <svg
          ...
          <div className="flex items-end flex-col w-[35%] max-sm:hidden">
            <svg
              className="h-auto w-full"
              ref={svgRef}
              width="470"
