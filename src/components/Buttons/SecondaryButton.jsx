  ...
  const sharedContent = (
    <>
      <div
        ...
        className="round relative flex items-center justify-center min-w-[13.5vw] h-[4.3vw] w-fit max-sm:h-[17vw] max-sm:min-w-[50vw] max-md:w-[27vw] max-md:h-[7vh]"
      >
        ...
        <div className="absolute inset-0 z-10">
          <div className=" btn-clipPath w-full absolute flex items-center justify-center h-full bg-white transition-all rounded-xs group-hover:scale-100 scale-x-[92%] scale-y-[82%] max-sm:scale-x-[93%] max-sm:scale-y-[80%] group-hover:bg-white duration-400 after:h-[1.5px] after:bg-[#A8a8a8] after:w-[2vw] after:-rotate-45 after:top-[14%] after:absolute after:left-[-3%] before:absolute before:h-[1.5px] before:w-[2vw] before:bg-[#A8a8a8] before:-rotate-45 before:right-[-3%] before:bottom-[14%]"></div>
