  ...
  const sharedContent = (
    <>
      <div
        ...
        className="round relative flex items-center justify-center w-[12.5vw] h-[4.3vw] max-sm:h-[17vw] max-sm:min-w-[50vw] max-md:w-[16vw] max-md:h-[6vw]"
      >
        <div className="absolute left-0 top-0 flex justify-start">
          <svg
            className="w-[5.5vw]  h-auto max-sm:w-[25vw]"
            width="101"
            height="55"
            viewBox="0 0 101 55"
            fill="none"
        ...
        <div className="absolute right-0 bottom-0 flex justify-end">
          <svg
            className="w-[5.5vw] h-auto rotate-180 max-sm:w-[25vw]"
            width="101"
            height="55"
            viewBox="0 0 101 55"
            fill="none"
        ...
        <div className="absolute inset-0 z-10">
          <div className=" btn-clipPath w-full absolute flex items-center justify-center h-full bg-trasnparent transition-all rounded-xs group-hover:scale-100 scale-x-[92%] scale-y-[82%] max-sm:scale-x-[93%] max-sm:scale-y-[80%] group-hover:bg-white duration-400 border border-[#a8a8a8] after:h-[1px] after:bg-[#A8a8a8] after:w-[2vw] after:-rotate-[47deg] after:top-[14.5%] after:absolute after:left-[-3%] before:absolute before:h-[1px] before:w-[1.9vw] before:bg-[#A8a8a8] before:-rotate-[48.8deg] before:right-[-3%] before:bottom-[15.5%] after:max-sm:top-[14.5%] before:max-sm:bottom-[15%]"></div>
