            ...
            <div className="round relative flex items-center justify-center w-[12.5vw] h-[4.3vw]">
                ...
                <div className="absolute inset-0 z-10">
                    <div
                        ...
                        className="w-full absolute flex items-center justify-center h-full bg-trasnparent transition-all rounded-xs group-hover:scale-100 scale-x-[92%] scale-y-[82%] duration-400 border border-[#a8a8a8] after:h-[1.5px] after:bg-[#A8a8a8] after:w-[2vw] after:-rotate-45 after:top-[14%] after:absolute after:left-[-3%] before:absolute before:h-[1.5px] before:w-[2vw] before:bg-[#A8a8a8] before:-rotate-45 before:right-[-3%] before:bottom-[14%]"
                    >
                    </div>
