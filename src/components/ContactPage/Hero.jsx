        ...
        <section className="w-screen relative h-screen  max-sm:pb-0 bg-background overflow-hidden">
            ...
            <div className="relative h-screen space-y-[7vw] max-sm:h-[80vh] max-sm:pt-[15vh] w-full flex flex-col items-center justify-center max-sm:items-start max-sm:px-[2vw]">
                ...
                <div ref={contactRef} className="flex items-center  max-sm:hidden max-md:flex-wrap  max-md:flex-row-reverse justify-center gap-[3vw] z-[99]">
                    <div className="relative w-[18vw] max-md:w-[40vw] max-md:h-[35vw] h-[18vw] z-[99] max-sm:w-[80vw] max-sm:h-[60vw]  pointer-events-none rounded-[1vw] hero-fadeup-contact">
                        <Image
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-between w-full h-full py-10 text-center p-4 space-y-[3vw] ">
                    ...
                    <a href={"mailto:contact@monielink.io"} target="_blank">
                        <div className="relative max-md:w-[40vw] max-md:h-[35vw] w-[18vw] h-[18vw] z-[99] pointer-events-none rounded-[1vw] hero-fadeup-contact cursor-pointer">
                            <Image
                                src="/assets/icons/contact/card-frame.png"
                                alt="card-frame"
                                fill
                                className="object-contain"
                            />
                            <div className="relative z-10 flex flex-col items-center justify-between py-10 w-full h-full text-center p-4 space-y-[3vw]">
                                ...
                                <Copy>
                                    <div className="h-[35%] flex items-start">
                                        <p className="text-content-20 text-gray-2">
                                            info@monielink.io
                                        </p>
                                    </div>
                    ...
                    <a href={"tel:+2348023970955"} target="_blank">
                        <div className="relative max-md:w-[40vw] max-md:h-[35vw] w-[18vw] h-[18vw] z-[99] pointer-events-none rounded-[1vw] hero-fadeup-contact cursor-pointer">
                            <Image
                                src="/assets/icons/contact/card-frame.png"
                                alt="card-frame"
                ...
                <div className="max-sm:flex max-sm:items-start hidden  justify-center gap-[3vw] z-[99] max-sm:flex-col max-sm:w-full max-sm:px-[5.5vw] max-sm:gap-0">
                    ...
                    <a href="mailto:contact@monielink.io">
