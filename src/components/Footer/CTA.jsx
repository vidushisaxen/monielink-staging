...
export default function CTA() {
  ...
  return (
    <section id="cta" className="w-screen relative h-screen bg-background max-sm:h-fit max-sm:py-[25%]">
      <div className="relative h-screen w-full flex flex-col items-center justify-center max-sm:h-fit">
        ...
        <div className={`h-fit pointer-events-none w-full flex-col flex items-center justify-center z-10 text-foreground max-sm:px-[5.5vw] max-sm:items-start max-sm:gap-[8vw]`}>
          <Copy>
            <h2
              className={`text-[5.2vw] font-display w-[75%] text-center leading-[1.25] text-[#D6D6D6] max-sm:text-head-100 max-sm:text-left max-sm:w-[80%]`}>
              Ready to Power Your Digital Banking Experience
            </h2>
          </Copy>

          <div className={`w-[48%] pt-[3vw] text-center text-[1.05vw] max-sm:w-[90%] max-sm:text-left max-sm:text-content-20`}>
            <Copy>
