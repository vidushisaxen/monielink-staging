...
export default function HeroBackground({
  ...
  return (
    <div className="w-screen max-md:h-[100vh] h-screen absolute inset-0 bg-background overflow-hidden flex flex-wrap max-sm:hidden max-md:hidden hero-background">
