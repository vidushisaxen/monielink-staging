...
export default function FAQs({ data }) {
  ...
  return (
    <section
      ...
      data-theme="white"
      id="faqs"
      className="bg-[#FBFBFB] py-[7%] px-[4.5vw] max-sm:px-[4.5vw] max-md:px-[2vw] white max-sm:py-[15%] max-md:py-[15%] max-sm:pt-[20%] w-screen overflow-hidden"
    >
                ...
                >
                  <div className="relative z-10 bg-[#F0F0F0] p-[2vw] rounded-[1vw] max-sm:px-[4vw] faq-inner max-sm:rounded-[2.5vw] max-md:p-[4vw]">
                    <AccordionItem value={itemKey}>
                      <AccordionTrigger
                        index={index}
                        className=" max-sm:text-content-18 font-display font-medium  max-md:text-[2.5vw] max-sm:text-left"
                      >
                        {faq.question}
                      </AccordionTrigger>
