  ...
  return (
    ...
    >
      ...
      <div className=" w-full flex items-center justify-center h-fit">
        <Copy>
          <p className="text-[#A8A8A8] introTextDescription text-[1.04vw] max-sm:text-[4vw] w-[40%] max-md:w-[80%] max-sm:w-[90%] max-sm:text-left text-center font-display max-sm:py-[5vw] max-md:py-[5vw] max-md:text-[3vw]">
