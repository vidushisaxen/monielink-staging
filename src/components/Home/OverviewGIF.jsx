...
export default function OverviewGIF() {
  ...
  return (
    <div ref={containerRef} id="overviewGif" className="w-[100vw] top-0 absolute max-sm:overflow-hidden max-sm:flex max-sm:items-center max-sm:h-[100vh] pointer-events-none">
      <svg
