...
const Wallet = ({heading}) => {
    ...
    const uspData = [
        {
            description: "Loan Disbursements & Credit Card issuance",
            width: "w-[40%]",
            svg: svgRefs[0],
            svgElement: <USP2 />
        },
        {
            description: "Credit Lifecycle & Portfolio Management ",
            width: "w-[40%]",
            svg: svgRefs[1],
            svgElement: <USP6 />
        },
            ...
            <div className='px-[4vw] py-[7vw] w-full h-full flex flex-col items-center justify-between space-y-[10vw] max-md:py-[10vw] max-sm:py-[20%] max-sm:items-start max-sm:px-[5.5vw]'>
                <div className='w-[90%] max-md:w-[95%] max-sm:w-full'>
                    <Copy>
                        ...
                        Monielink enables end-to-end loan & credit card management, helping lenders Create & Grow Profitable Portfolios through a complete cloud-based ecosystem 
                        </h2>
                    </Copy>
                </div>
