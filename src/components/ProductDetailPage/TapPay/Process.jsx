        ...
        <>
            <section data-theme="orange" className='w-screen h-full overflow-hidden bg-gradient relative max-sm:py-[15%]' ref={sectionRef}>
                <div className='px-[4vw] py-[7vw] flex flex-col items-center  gap-[10vw] max-sm:px-[5.5vw]'>
                    ...
                    <svg className='w-full h-full' ref={svgRef} width="669" height="395" viewBox="0 0 669 395" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g className='card'>
<path d="M78.2726 197.716L2.32804 102.785C1.33146 101.539 2.12293 99.6855 3.71191 99.5436L248.099 77.7233C250.56 77.5036 252.985 78.4335 254.668 80.2428L339.266 171.186C340.391 172.395 339.65 174.368 338.008 174.538L85.3428 200.676C82.636 200.956 79.9725 199.841 78.2726 197.716Z" fill="#FFFEFE" stroke="white"/>
</g>
<g className='device'>
