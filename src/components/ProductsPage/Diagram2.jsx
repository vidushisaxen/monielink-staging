...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_94_554" result="shape"/>
                 ...
                 <div className='w-[100vw] hidden max-sm:block max-md:block     overflow-visible'>
                                 ...
                                 <div className='max-sm:w-fit max-md:w-full  max-sm:overflow-x-scroll relative max-md:pl-[5vw] max-sm:pl-[30vw] '>
                                     <div className='max-sm:w-[150%] max-md:w-[90%]'>
                 ...
                 <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_0_3" result="shape"/>
                             ...
                             <div>
                                 ...
                                 <div >
                                         <div className='absolute max-md:top-[20%] max-sm:top-[19%] max-sm:left-[17%] max-md:left-[13%] max-md:w-[20%] max-sm:w-[30%] overflow-hidden'>
                                             <Copy>
                                                         <p className="max-md:text-content-20 max-sm:text-[3.5vw] text-center">Partner Infrastructure</p>
                                                         </Copy>
                                         </div>
                                         <div className='absolute max-sm:top-[19%] max-md:top-[20%] max-sm:right-[-11%] max-sm:w-[25%] max-md:w-[15%] max-md:right-[20%] w-[25%] overflow-hidden'>
                                             <p className='max-md:text-content-20 max-sm:text-[3.5vw] text-center'>Secure VPS Tunnel</p>
                                         </div>
                                 ...
                                 <div className=" w-[18%] max-md:w-[32%] max-sm:w-[30%] overflow-visible">
                                   <ul className="max-sm:pl-[12vw] max-md:pl-[2vw] list-disc space-y-[0.5vw] font-medium text-content-24 w-full max-md:text-content-20 max-md:w-full font-body  text-center   max-sm:text-[4vw] max-sm:text-left max-md:text-left">
                                     <li>Fund Transfers</li>
                                     <li>Collect payments/ Settlements</li>
                                     <li>Digital Payments</li>
                                   </ul>
