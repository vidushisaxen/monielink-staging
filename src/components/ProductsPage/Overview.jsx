...
const Overview = () => {
  return (
    ...
    <div className='h-full w-full py-[8vw] px-[8vw]  flex justify-center max-sm:px-[5.5vw] max-md:flex-col max-sm:flex-col max-sm:py-[25%] max-sm:pt-[40%] max-sm:gap-[8vw] max-md:gap-[5vw]'>
      <div className='w-[45%] max-md:w-[100%] flex items-start max-sm:w-full'>
        ...
        <div className='absolute top-[12%] left-[12%] h-[3vw] w-[3vw] max-md:top-[14%] max-md:w-[10vw] max-md:h-[10vw] max-md:left-[8%] max-sm:top-[14%] max-sm:left-[7%] max-sm:w-[15vw] max-sm:h-auto overflow-hidden'>
<Image src={"/assets/icons/overview-icon.svg"} height={50} width={50} alt='overview-icon' className='h-full w-full fadeupanim'/>
        </div>
      </div>
  
      <div className='w-[42%] max-md:w-[100%] flex items-end max-sm:w-full'>
        <Copy>
