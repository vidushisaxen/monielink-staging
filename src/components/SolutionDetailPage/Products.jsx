...
const Products = ({ productData }) => {
  return (
    <section
      data-theme="white"
      id="features"
      className="bg-white-1 text-black-1 w-screen"
    >
      <div className="px-[4.5vw] py-[8vw] max-sm:px-[5.5vw] max-sm:py-[15%]">
        <div className="w-full flex items-start justify-between max-sm:flex-col max-md:flex-col gap-[4vw]">
          <div className="w-[52%] max-md:w-[70%] max-sm:w-full sticky top-[20%] self-start">
            <Copy>
          ...
          <div className="w-[45%] flex flex-col items-center space-y-[5vw]">
