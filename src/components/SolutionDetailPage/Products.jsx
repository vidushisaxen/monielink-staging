    ...
    >
      <div className="px-[4.5vw] py-[8vw] w-full space-y-[8vw] max-sm:px-[5.5vw] max-sm:py-[15%] max-md:py-[15%] max-sm:space-y-[12vw]">
        <div className="w-full flex items-center justify-between max-sm:flex-col max-sm:items-start max-md:items-start max-md:flex-col">
          ...
          <div className="flex flex-col gap-[2vw] items-start w-[30%] justify-start max-sm:w-full max-sm:pt-0 max-md:pt-[10vw] max-md:w-full max-sm:gap-[8vw] max-md:gap-[4vw]">
            <div className="h-[4vw] w-[10vw] max-md:w-[30vw] max-md:h-auto fadeupanim max-sm:w-[50vw] max-sm:h-auto">
              <Image
        ...
        <div className="w-full flex items-center justify-between max-sm:flex-col max-sm:items-start max-md:flex-col max-md:items-start max-md:space-y-[8vw] max-sm:space-y-[12vw]">
          ...
          <div className="flex flex-col gap-[2vw] items-start w-[30%] justify-start max-sm:w-full max-md:w-full max-md:gap-[4vw] max-sm:gap-[8vw]">
            <div className="h-[4vw] w-[10vw] max-md:w-[25vw] max-md:h-auto fadeupanim max-sm:w-[35vw] max-sm:h-auto">
              <Image
