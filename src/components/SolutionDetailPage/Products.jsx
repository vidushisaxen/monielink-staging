  ...
  return (
    ...
    >
      <div className="px-[4.5vw] py-[8vw] max-sm:px-[5.5vw] max-sm:py-[15%]">
        <div className="w-full flex items-start justify-between max-sm:flex-col max-md:flex-col gap-[4vw] max-sm:gap-[10vw] max-md:gap-[7vw]">
          <div className="w-[52%] max-md:w-[70%] max-sm:w-full sticky top-[20%] self-start max-sm:static max-md:static">
            <Copy>
          ...
          <div className="w-[45%] flex flex-col items-center space-y-[5vw] max-sm:w-full max-sm:space-y-[10vw] max-md:space-y-[10vw] max-md:w-full">
