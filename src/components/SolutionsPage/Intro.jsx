...
const Intro = () => {
    ...
    return (
        <section data-theme="orange" className="bg-gradient overflow-hidden h-screen max-md:h-[70vh] max-sm:h-[75vh] relative">
            <div className="px-[4vw] flex justify-center items-center h-full w-full relative">
                <div className="text-center text-white w-1/2 flex flex-col items-center gap-10 max-sm:w-full">
                    ...
                    <Copy>
                        <p className="text-content-20 w-3/5">Enable seamless digital banking experiences for your customers through your mobile app. The Moneylink Super SDK empowers banks and fintechs to launch B2B2C services quickly, securely, and at scale — all from a single integration.</p>
                    </Copy>
                </div>
                <div className="absolute w-[75%] max-sm:w-[170%] max-md:w-[120vw]">
